 ...
 */
final class Version20230330112758 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_to_book_format (id INT NOT NULL, book_id INT NOT NULL, book_format_id INT NOT NULL, price NUMERIC(10, 2) NOT NULL, discount_percent INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D02DE22216A2B381 ON book_to_book_format (book_id)');
        $this->addSql('CREATE INDEX IDX_D02DE222C487E043 ON book_to_book_format (book_format_id)');
        $this->addSql('CREATE TABLE review (id INT NOT NULL, book_id INT DEFAULT NULL, rating INT NOT NULL, content TEXT NOT NULL, authors VARCHAR(255) NOT NULL, created_at DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE book_to_book_format ADD CONSTRAINT FK_D02DE222C487E043 FOREIGN KEY (book_format_id) REFERENCES book_format (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE book ADD isbn VARCHAR(15) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book_to_book_format DROP CONSTRAINT FK_D02DE222C487E043');
